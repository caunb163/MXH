...
class PostVideo2ViewHolder(
    ...
    private var img21: ImageView = view.findViewById(R.id.media_2_video_1)
    ...
    override fun bind(post: PostEntity, user: User, onHomeOnClick: HomeOnClick) {
        ...
        glide.applyDefaultRequestOptions(RequestOptions()).load(post.video).into(img21)
