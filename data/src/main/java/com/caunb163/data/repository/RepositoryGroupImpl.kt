...
class RepositoryGroupImpl(
    ...
    private val TAG = "RepositoryGroup"
    private val db = Firebase.firestore

    suspend fun getAllMyGroup(userId: String): MutableList<GroupEntity> {
        val data = db.collection("Groups").whereArrayContains("arrUserId", userId).get().await()
        ...
        groupEntityList.sortByDescending { it.createDate.inc() }
